...
%----------------------------------------
\begin{frame}[fragile]
  \frametitle{Process Overview}
    \pause
    \begin{enumerate}
      \item <2->\textbf{Step One Title}
      \only<2>{
          \begin{itemize}
            \item <2> First substep description
            \item <2> Second substep description
          \end{itemize}
      }
      \item <3-> \textbf{Step Two Title}
      \only<3>{
          \begin{itemize}
            \item <3> First substep description
            \item <3> Second substep description
          \end{itemize}
      }
          
      \item <4-> \textbf{Step Three Title}
      \only<4>{
          \begin{itemize}
            \item <4> First substep description
            \item <4> Second substep description
          \end{itemize}
      }

      \item <5-> \textbf{Step Four Title}
      \only<5>{
          \begin{itemize}
            \item <5> First substep description
            \item <5> Second substep description
          \end{itemize}
      }

      \item <6-> \textbf{Step Five Title}
      \only<6>{
          \begin{itemize}
            \item <6> First substep description
            \item <6> Second substep description
          \end{itemize}
      }
    \end{enumerate}
\end{frame}
